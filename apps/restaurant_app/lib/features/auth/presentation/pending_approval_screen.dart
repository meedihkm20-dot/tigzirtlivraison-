...
class PendingApprovalScreen extends StatelessWidget {
  ...
  Future<void> _whatsAppAdmin() async {
    final uri = Uri.parse('https://wa.me/$adminWhatsApp?text=Bonjour,%20je%20souhaite%20activer%20mon%20compte%20restaurant%20sur%20DZ%20Delivery');
    if (await canLaunchUrl(uri)) {
      await launchUrl(uri, mode: LaunchMode.externalApplication);
    }
  }
  ...
  Future<void> _checkStatus(BuildContext context) async {
    try {
      ...
      if (restaurant != null && restaurant['is_verified'] == true) {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Votre demande d\'inscription a été enregistrée.\n\nContactez-nous pour finaliser votre inscription et signer le contrat de partenariat.',
