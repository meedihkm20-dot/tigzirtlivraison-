...
class _RestaurantHomeScreenState extends State<RestaurantHomeScreen> {
  ...
  void _onNavTap(int index) {
    ...
    if (index == 1) Navigator.pushNamed(context, AppRouter.menu);
    if (index == 2) Navigator.pushNamed(context, AppRouter.stats);
    if (index == 3) Navigator.pushNamed(context, AppRouter.restaurantProfile);
  }
      ...
      case 'pending':
        return Row(
          children: [
            ...
            const SizedBox(width: 12),
            Expanded(child: ElevatedButton(onPressed: () => _confirmOrder(orderId), child: const Text('Confirmer'))),
          ],
        );
      case 'confirmed':
